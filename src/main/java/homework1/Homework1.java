...
//        Поехали!!!
        ...
        System.out.println("3\n" +
                ...
                "Поехали!!!\n");
//      Text block
//      Функция Text Block предоставляет разработчикам новый улучшенный способ создания многострочной строки в Java
//      без конкатенаций и escape-последовательностей.
//      Текстовые блоки доступны в качестве стандартной опции, начиная с Java 15
//      Текстовый блок начинается с трех символов двойных кавычек
        System.out.println("""
                3
                2
                1
...
//        Поскольку результатом текстового блока является строка,
//        в Text Block поддерживаются все строковые методы, такие как substring equal, trim, indexOf и другие.
